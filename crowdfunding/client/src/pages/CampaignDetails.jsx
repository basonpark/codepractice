        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            ...
            flex-wrap gap-[14px]'>
              ...
              justify-center bg-[#2c2f32] rounded-full cursor-pointer'>
                <img src={thirdweb} alt='user' className='w-[60%] h-[60%] object-contain' />
              </div>
              <div>
                <h4 className='font-epilogue font-semibold text-[14px] 
                text-white breakall'>{state.owner}</h4>
          ...
          <div>
            ...
            <div className='mt-[20px]'>
              ...
              leading-[26px] text-justify text-[#808191]'>
                {state.description}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              {donators.length > 0 ? donators.map((donator,
               i) => (
                <div key={`${item.donator}-${index}`} className='flex justify-between
                items-center gap-4'>
                  <p className='font-epologue font-normal text-[16px] text-[#b2b3bd]
                  leading-[26px] break-all'>{index+1}.{item.donator}</p>
                  <p className='font-epologue font-normal text-[16px] text-[#808191]
                  leading-[26px] break-all'>{index+1}.{item.donation}</p>
                </div>
               )) : (
                <p className='font-epilogue font-normal text-[16px]
                leading-[26px] text-justify text-[#808191]'>
          ...
          rounded-[10px]'>
            ...
            <div className='mt-[30px]'>
              ...
              <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                ...
                leading-[22px] text-[#808191]'>Support the project for no reward because it speaks to you</p>
              </div>
