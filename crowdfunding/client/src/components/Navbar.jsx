  ...
  return (
    ...
    mb-[35px] gap-6'>
        ...
        bg-[#1c1c24] rounded-[100px]'>
            ...
            <input type="text" placeholder="Search for campaigns" className='flew 
            w-full font-epilogue placeholder:text-[#hb5264] text-white bg-transparent outline-none
            font-normal text-[14px]'></input>

            <div className='w-[72px] h-full rounded-[20px] bg-[#4acd8d] flex
            justify-center items-center cursor-pointer'>
                <img src={search} alt="search" className='w-1/2 h-1/2 object-contain' />
            </div>
        ...
        left-0 bg-[#1c1c24] z-10 shadow-secondary p-4 
            ...
            <ul className='mb-4'>
                {navlinks.map((link) => (
                    ...
                    >
                        ...
                        <p className={`ml-[30px] font-epilogue font-semibold text-[14px] ${isActive === link.name ? 'text-[#1dc071]' : 'text-[#808191]'}`}>
                            {link.name}
                        </p>
